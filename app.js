...
console.log(`${Michaelinfo.firstName} has ${Michaelinfo.hobbies.length} hobbies and has ${Michaelinfo.freinds.length} freinds and his best friend is called ${Michaelinfo.freinds[Michaelinfo.freinds.length-1]}`)
